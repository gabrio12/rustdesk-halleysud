...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Accept sessions via password", "Solo con password"),
        ("Accept sessions via click", "Solo con clic di conferma"),
        ("Accept sessions via both", "Con password o clic di conferma"),
